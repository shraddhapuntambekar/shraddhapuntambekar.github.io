...
> **Currently:** at Cognizant, engaged with a pharma client as Bioinformatics SME validating 17 omics Nextflow pipelines (genomics, transcriptomics), authoring developer documentation and runbooks, and capturing as-is (on-prem) and to-be (on-cloud) architectures for proteomics and metabolomics analysis pipelines. (Nextflow · Azure DevOps · GitHub Actions · Google Cloud Workflows · Seqera Tower).
